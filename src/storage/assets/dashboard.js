    ...
    return new Plugin({
      ...
      view: (view) => {
        ...
        toggle.addEventListener('click', (e) => {
          ...
          view.nodeDOM(view.state.selection.$from.pos);
          let toolbarActions = [
            {
          ...
          for (let action of toolbarActions) {
            ...
            if (action.icon) {button.innerHTML = action.icon;}          button.insertAdjacentHTML('beforeend', `<span>${action.label}</span>`);
...
`
    ...
    initTipTapEditor(settings) {
      ...
      return new Editor$1({
        ...
        onTransaction: ({ editor, transaction }) => {
          ...
          resolvedPos.nodeAfter || resolvedPos.parent;
  ...
  exports.ClientSideForms = ClientSideForms;
